  ...
  return (
    <main className={styles.ctaShell}>
      <div
        ...
        role="region"
        aria-labelledby="membership-choose-title"
      >
        <div className={styles.ctaHeadingRow}>
          <h1 id="membership-choose-title" className={styles.gateTitle}>
            Choose a form
          </h1>
          <div className={styles.ctaIntro}>
            Select whether you&apos;re a Victory member or not to continue.
          </div>
        </div>
          ...
          >
            ...
            <div>
              ...
              <div className={styles.ctaDesc}>
                Forms for church partners who are not Victory members
              </div>
            </div>
          </ButtonBase>
