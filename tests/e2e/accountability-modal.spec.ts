...
test('Accountability modal shows on victory flow and cancel returns to landing', async ({
  page,
}) => {
  ...
  await expect(
    agreement.getByText(/grateful for the opportunity to advance the gospel to the nations/i),
  ).toBeVisible();
